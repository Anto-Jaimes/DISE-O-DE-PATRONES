...
public class DataInicializador implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (partidoRepo.count() == 0) {
            ...
            // ================= OCTAVOS DE FINAL =================
            partidoRepo.save(new Partido("Paraguay", "Francia", "2026-06-26 15:00", "Fútbol", 3.0, 3.2, 1.9, "Estadio Azteca"));
            partidoRepo.save(new Partido("Canadá", "Marruecos", "2026-06-26 18:00", "Fútbol", 2.8, 3.0, 2.1, "MetLife Stadium"));
            partidoRepo.save(new Partido("Portugal", "España", "2026-06-27 15:00", "Fútbol", 2.6, 3.1, 2.3, "SoFi Stadium"));
            partidoRepo.save(new Partido("Estados Unidos", "Bélgica", "2026-06-27 18:00", "Fútbol", 3.5, 3.3, 1.8, "AT&T Stadium"));
            
            partidoRepo.save(new Partido("Brasil", "Noruega", "2026-06-28 15:00", "Fútbol", 1.6, 3.4, 4.2, "Hard Rock Stadium"));
            partidoRepo.save(new Partido("México", "Inglaterra", "2026-06-28 18:00", "Fútbol", 3.2, 3.1, 2.0, "Mercedes-Benz Stadium"));
            partidoRepo.save(new Partido("Argentina", "Egipto", "2026-06-29 15:00", "Fútbol", 1.5, 3.5, 4.5, "Gillette Stadium"));
            partidoRepo.save(new Partido("Suiza", "Colombia", "2026-06-29 18:00", "Fútbol", 2.4, 3.0, 2.5, "NRG Stadium"));

            // ================= CUARTOS DE FINAL =================
            partidoRepo.save(new Partido("Ganador PAR/FRA", "Ganador CAN/MAR", "2026-07-03 15:00", "Fútbol", 2.0, 3.0, 2.0, "SoFi Stadium"));
            partidoRepo.save(new Partido("Ganador POR/ESP", "Ganador USA/BEL", "2026-07-03 18:00", "Fútbol", 2.0, 3.0, 2.0, "AT&T Stadium"));
            partidoRepo.save(new Partido("Ganador BRA/NOR", "Ganador MEX/ENG", "2026-07-04 15:00", "Fútbol", 2.0, 3.0, 2.0, "Hard Rock Stadium"));
            partidoRepo.save(new Partido("Ganador ARG/EGY", "Ganador SUI/COL", "2026-07-04 18:00", "Fútbol", 2.0, 3.0, 2.0, "Mercedes-Benz Stadium"));

            // ================= SEMIFINALES =================
            partidoRepo.save(new Partido("Ganador CF1", "Ganador CF2", "2026-07-08 15:00", "Fútbol", 2.0, 3.0, 2.0, "MetLife Stadium"));
            partidoRepo.save(new Partido("Ganador CF3", "Ganador CF4", "2026-07-09 15:00", "Fútbol", 2.0, 3.0, 2.0, "Gillette Stadium"));

            // ================= TERCER PUESTO Y FINAL =================
            partidoRepo.save(new Partido("Perdedor Semifinal 1", "Perdedor Semifinal 2", "2026-07-12 15:00", "Fútbol", 2.0, 3.2, 2.8, "Hard Rock Stadium"));
            partidoRepo.save(new Partido("Ganador Semifinal 1", "Ganador Semifinal 2", "2026-07-13 15:00", "Fútbol", 2.0, 3.0, 2.0, "Estadio Azteca"));
        }
